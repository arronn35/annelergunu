...
export const HeartGift = ({ size = 280 }) => (
...
export const Flower = ({ size = 60, hue = 'pink' }) => {
  const palettes = {
...
export const Butterfly = ({ size = 50, color = '#F48FB1' }) => {
  const id = React.useId();
  return (
...
export const HeartShape = ({ size = 30, color = '#EC407A' }) => (
...
export const Petal = ({ size = 18, color = '#FFB6C8' }) => (
